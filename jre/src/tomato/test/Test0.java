...
public class Test0 {
    public static void main(String[] args) throws IOException {
        ...
        new Test44().test();
        new Test45().test();
        //new tomato.test.Test46().tomato.test();
        new Test47().test();
...
//
//       // new tomato.test.Test71().tomato.test();
//        // 加载Throwable
//        new tomato.test.Test73().tomato.test();
//        new tomato.test.Test75().tomato.test();
//
        new Test78().test();
        new Test79().test();
        new Test106().test();
