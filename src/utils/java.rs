...
pub fn create_class_object(class_name: &String) -> u64 {
    ...
    let mut referencre: Reference = get_reference(&obj_id).unwrap();
    match referencre {
        Reference::Object(mut object) => {
            object
                .field
