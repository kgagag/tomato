pub mod op_code {
    ...
    use crate::runtime::{global::*, metaspace};
    use crate::runtime::heap::Heap;
    extern crate env_logger;
    extern crate log;
   
    pub fn run(thread_id : u64, heap : &mut Heap , metaspace : &mut Metaspace , vm_stack : &mut Vec<StackFrame>) 
    {
        while !vm_stack.is_empty() {
            let len = vm_stack.len();
            let frame = vm_stack[len - 1];
            ...
            match code {
                ...
                0x12 => ldc(thread_id,vm_stack,heap,metaspace),
                0x13 => ldc_w(vm_stack),
                0x14 => ldc2_w(vm_stack,metaspace),
                ...
                0x2e => iaload(vm_stack,heap),
                0x2f => laload(vm_stack,heap),
                0x30 => faload(vm_stack,heap),
                0x31 => daload(vm_stack,heap),
                0x32 => aaload(vm_stack,heap),
                0x33 => baload(vm_stack,heap),
                0x34 => caload(vm_stack,heap),
                0x35 => saload(vm_stack,heap),
                ...
                0x4f => iastore(vm_stack,heap),
                0x50 => lastore(vm_stack,heap),
                0x51 => fastore(vm_stack,heap),
                0x52 => dastore(vm_stack,heap),
                0x53 => aastore(vm_stack,heap),
                0x54 => bastore(vm_stack,heap),
                0x55 => castore(vm_stack,heap),
                0x56 => sastore(vm_stack,heap),
                ...
                0xb2 => getstatic(frame,vm),
                0xb3 => putstatic(frame,vm),
                0xb4 => getfield(frame,vm),
                0xb5 => putfield(frame,vm),
                0xb6 => invokevirtual(frame,vm,vm_stack),
                0xb7 => invokespecial(frame,vm,vm_stack),
                0xb8 => invokestatic(frame,vm,vm_stack),
                0xb9 => invokeinterface(frame,vm,vm_stack),
                // 0xba => invokedynamic(vm_stack.last_mut().unwrap()),
                0xbb => _new(frame,vm),
                0xbc => newarray(frame,vm),
                0xbd => anewarray(frame,vm),
                0xbe => arraylength(frame,vm),
                0xbf => athrow(vm_stack.last_mut().unwrap()),
                0xc0 => checkcast(vm_stack.last_mut().unwrap()),
                0xc1 => instanceof(frame,vm),
                0xc2 => monitorenter(vm_stack.last_mut().unwrap()),
                0xc3 => monitorexit(vm_stack.last_mut().unwrap()),
                // 0xc4 => wide(vm_stack.last_mut().unwrap()),
                 0xc5 => multianewarray(frame,vm),
