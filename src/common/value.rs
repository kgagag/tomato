    ...
    match v {
        ...
        StackFrameValue::Long(data) => {
            if *data < i32::MIN as i64 || *data > i32::MAX as i64 {
                return Err(Throwable::Exception(Exception::ArithmeticException));
            }
            Ok(*data as i32)
        },
        ...
        StackFrameValue::Float(_) | StackFrameValue::Double(_) => {
            Err(Throwable::Exception(Exception::IllegalArgumentException))
        },
        ...
        _ => Err(Throwable::Exception(Exception::IllegalArgumentException)),
    }
}
